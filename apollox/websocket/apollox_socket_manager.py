...
from apollox.websocket.apollox_client_factory import ApolloxClientFactory


class ApolloxSocketManager(threading.Thread):
    ...
    def _start_socket(
        ...
        factory = ApolloxClientFactory(factory_url, payload=payload)
        factory.base_client = self
        factory.protocol = ApolloxClientProtocol
